    ...
    <<
      \new StaffGroup <<
        \new Staff
        {
          ...
          \new Voice { \keepWithTag #'score << \outline \partCombine \fluteCOneScore \fluteCTwoScore >> }
        }
        \new Staff
        {
          #(set-accidental-style 'modern)
          ...
          \new Voice { \keepWithTag #'score \oboeCScore }
        }
        \new Staff
        {
          #(set-accidental-style 'modern)
          ...
          \new Voice { \keepWithTag #'score \bassoonCScore }
        }
        \new GrandStaff <<
          \new Staff
          {
            ...
            \new Voice { \keepWithTag #'score \clarBesOneScore }
          }
          \new Staff
          {
            #(set-accidental-style 'modern)
            ...
            \set Staff.aDueText = #"unis."
            \new Voice { \keepWithTag #'score << \partCombine \clarBesTwoScore \clarBesThreeScore >> }
          }
          \new Staff
          {
            #(set-accidental-style 'modern)
            ...
            \new Voice { \keepWithTag #'score \bassclarBesScore }
          }
        >>
        \new GrandStaff <<
          \new Staff
          {
            ...
            \set Staff.soloIIText = #"2."
            \set Staff.aDueText = #"unis."
            \new Voice { \keepWithTag #'score << \partCombine \altosaxEesOneScore \altosaxEesTwoScore >> }
          }
          \new Staff
          {
            #(set-accidental-style 'modern)
            ...
            \new Voice { \keepWithTag #'score \tenorsaxBesScore }
          }
          \new Staff
          {
            #(set-accidental-style 'modern)
            ...
            \new Voice { \keepWithTag #'score \barisaxEesScore }
          }
        >>
      >>
      \new StaffGroup <<
        \new GrandStaff <<
          \new Staff
          {
            ...
            \new Voice { \keepWithTag #'score \trumpetBesOneScore }
          }
          \new Staff
          {
            #(set-accidental-style 'modern)
            ...
            \set Staff.soloIIText = #"3."
            \set Staff.aDueText = #"unis."
            \new Voice { \keepWithTag #'score << \partCombine \trumpetBesTwoScore \trumpetBesThreeScore >> }
          }
        >>
        \new Staff
        {
          ...
          \set Staff.soloIIText = #"2."
          \set Staff.aDueText = #"unis."
          \new Voice { \keepWithTag #'score << \partCombine \hornFOneScore \hornFTwoScore >> }
        }
        \new GrandStaff <<
          \new Staff
          {
            ...
            \new Voice { \keepWithTag #'score \tromCOneScore }
          }
          \new Staff
          {
            #(set-accidental-style 'modern)
            ...
            \set Staff.soloIIText = #"3."
            \set Staff.aDueText = #"unis."
            \new Voice { \keepWithTag #'score << \partCombine \tromCTwoScore \tromCThreeScore >> }
          }
        >>
        \new Staff
        {
          ...
          \new Voice { \keepWithTag #'score \baritoneCScore }
        }
        \new Staff
        {
          #(set-accidental-style 'modern)
          ...
          \new Voice { \keepWithTag #'score \tubaCScore }
        }
        \new Staff
        {
          #(set-accidental-style 'modern)
          ...
          \new Voice { \keepWithTag #'score \stringbassCScore }
        }
      >>
      \new StaffGroup <<
