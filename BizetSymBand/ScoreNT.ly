...
\book
{
  ...
  \score
  {
    ...
    <<
      \new StaffGroup <<
        \doubleStaffTempo
            "Flute 1, 2" #(markup #:column ("Fl." #:line ("1, 2"))) #"1." #"2." \fluteOneScore \fluteTwoScore
      ...
      \new StaffGroup <<
        ...
        \new GrandStaff <<
          ...
          \doubleStaff "Trombone 2, 3" #(markup #:column ("Trm." #:line ("2, 3"))) #"2." #"3." \tromTwoScore \tromThreeScore
        >>
      ...
      \new StaffGroup <<
        ...
        \singleStaff "Mallet Percussion" "Mal." \malletScore
