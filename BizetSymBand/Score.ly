...
\book
{
  ...
  \score
  {
    ...
    <<
      \new StaffGroup <<
        \doubleStaffTempo
            "Flute 1, 2" #(markup #:column ("Fl." #:line ("1, 2"))) #"1." #"2." \fluteCOneScore \fluteCTwoScore
        ...
        \new GrandStaff <<
          ...
          \singleStaff
              #(markup #:column ("Bass Clarinet" #:line ("in B" #:smaller #:flat))) "B.Cl." \bassclarBesScore
        >>
        \new GrandStaff <<
          \doubleStaff
          ...
          \singleStaff
              #(markup #:column ("Tenor Saxophone" #:line ("in B" #:smaller #:flat))) "T.Sx." \tenorsaxBesScore
          \singleStaff
              #(markup #:column ("Baritone Saxophone" #:line ("in E" #:smaller #:flat))) "B.Sx." \barisaxEesScore
        >>
      >>
      \new StaffGroup <<
        \new GrandStaff <<
        ...
        >>
        \doubleStaff
            "Horn 1, 2 in F" #(markup #:column ("Hn." #:line ("1, 2"))) #"1." #"2." \hornFOneScore \hornFTwoScore
        \new GrandStaff <<
          \singleStaff "Trombone 1" "Trm.1" \tromCOneScore
          \doubleStaff
              "Trombone 2, 3" #(markup #:column ("Trm." #:line ("2, 3"))) #"2." #"3." \tromCTwoScore \tromCThreeScore
        >>
      ...
      \new StaffGroup <<
        ...
        \singleStaff "Mallet Percussion" "Mal." \malletCScore
