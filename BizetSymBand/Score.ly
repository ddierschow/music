      ...
      <<
        ...
        <<
          \new Staff
          {
            ...
            \new Voice { \keepWithTag #'score \relative c \trumpetBesOneScore }
          }
          \new Staff
          {
            #(set-accidental-style 'modern)
        ...
        <<
          ...
          {
            #(set-accidental-style 'modern)
            \set Staff.instrumentName = \markup { \column { "Trombone 1" } }
            \set Staff.shortInstrumentName = "Trm.1"
            \new Voice { \keepWithTag #'score \tromboneCOneScore }
          }
          \new Staff
          {
            #(set-accidental-style 'modern)
            \set Staff.instrumentName = \markup { \column { "Trombones 2, 3" } }
        ...
        >>
          \new Staff
          {
            ...
            \new Voice { \keepWithTag #'score \relative c \baritoneCScore }
          }
	  \new Staff
	  {
	    #(set-accidental-style 'modern)
	    ...
	    \new Voice { \keepWithTag #'score \relative c \tubaCScore }
	  }
          \new Staff
          {
            #(set-accidental-style 'modern)
            ...
            \new Voice { \keepWithTag #'score \relative c \stringbassCScore }
          }
      >>
      \new StaffGroup
      <<
